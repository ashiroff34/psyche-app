  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <Link
          href="/pricing?from=type_self_work_gate"
        ...
        >
          Unlock Self Work — Free for {PRO_TRIAL_DAYS} days →
        </Link>
        <p className="text-xs" style={{ color: "rgba(255,255,255,0.28)" }}>
          Earn Pro access through 25+ referrals · already a member? <Link href="/pricing?from=restore_link" style={{ color: "rgba(251,191,36,0.6)" }}>restore</Link>
        </p>
      </motion.div>
...
const SELF_WORK_DATA: Record<number, {
  ...
  5: {
    ...
    shadowPrompt: "What are you hoarding right now: energy, information, time? Who does that protect you from?",
