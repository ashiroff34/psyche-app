  ...
  if (showGuide) {
    return (
      <div className="min-h-screen">
        ...
        <AssessmentGuide assessmentName="Cognitive Functions Assessment" onReady={() => setShowGuide(false)} />
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-2xl mx-auto px-4 pt-6">
        ...
        <p className="text-sm text-slate-400 mb-2">Advanced Jungian analysis — {items.length} items assessing all 8 cognitive functions individually.</p>
      </div>
      <LikertAssessment
