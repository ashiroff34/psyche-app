  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-2xl mx-auto px-4 pt-6">
        ...
        <h1 className="text-2xl font-serif font-bold mb-1" style={{ color: "rgba(255,255,255,0.95)" }}>Adaptive Narrowing</h1>
        <p className="text-sm mb-2" style={{ color: "rgba(255,255,255,0.5)" }}>Progressive questions that narrow down your type, starts broad, gets specific.</p>
      </div>
      <AdaptiveAssessment
