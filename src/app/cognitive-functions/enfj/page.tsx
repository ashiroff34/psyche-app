...
const type = mbtiTypes.find((t) => t.code === "ENFJ")!;

export const metadata: Metadata = {
  title: "ENFJ Personality Type — Cognitive Functions, Traits & Growth | Thyself",
  description:
    "The complete guide to the ENFJ cognitive function stack (Fe-Ni-Se-Ti). Understand dominant Extraverted Feeling, auxiliary Introverted Intuition, the Fe-Se loop, grip stress, common mistypes, and the ENFJ growth path. Grounded in Jungian theory.",
  openGraph: {
    title: "ENFJ: Cognitive Functions, Traits & Growth",
    description:
      "ENFJs lead with Extraverted Feeling — reading social and emotional landscapes with precision — supported by Introverted Intuition. A complete guide to the ENFJ cognitive function stack and growth path.",
    url: "https://thyself.app/cognitive-functions/enfj",
    type: "article",
    siteName: "Thyself",
  },
  alternates: { canonical: "https://thyself.app/cognitive-functions/enfj" },
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "ENFJ Personality Type — Cognitive Functions, Traits & Growth",
  description:
    "The complete guide to the ENFJ cognitive function stack (Fe-Ni-Se-Ti), loop patterns, grip stress, and growth path. Grounded in Jungian theory.",
  author: { "@type": "Organization", name: "Thyself", url: "https://thyself.app" },
  publisher: { "@type": "Organization", name: "Thyself", url: "https://thyself.app" },
  url: "https://thyself.app/cognitive-functions/enfj",
  datePublished: "2026-04-24",
  dateModified: "2026-04-24",
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://thyself.app/cognitive-functions/enfj" },
};
    ...
    <>
      ...
      <main className="min-h-screen bg-white">
        ...
        <div className="mx-auto max-w-3xl px-6 py-12 space-y-16">
          ...
          {/* Cognitive wiring */}
          <section>
            <h2 className="mb-4 text-2xl font-bold text-gray-900">How the ENFJ Mind Works</h2>
          ...
          <section>
            ...
            <p className="mb-4 text-gray-700 text-sm leading-relaxed">
              ENFJs are frequently mistyped as other types because cognitive function stacks overlap in surface behavior.
