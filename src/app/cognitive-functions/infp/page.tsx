...
const type = mbtiTypes.find((t) => t.code === "INFP")!;

export const metadata: Metadata = {
  title: "INFP Personality Type — Cognitive Functions, Traits & Growth | Thyself",
  description:
    "The complete guide to the INFP cognitive function stack (Fi-Ne-Si-Te). Understand dominant Introverted Feeling, auxiliary Extraverted Intuition, the Fi-Si loop, grip stress, common mistypes, and the INFP growth path. Grounded in Jungian theory.",
  openGraph: {
    title: "INFP: Cognitive Functions, Traits & Growth",
    description:
      "INFPs lead with Introverted Feeling — navigating the world through a rich internal value system — supported by Extraverted Intuition. A complete guide to the INFP cognitive function stack and growth path.",
    url: "https://thyself.app/cognitive-functions/infp",
    type: "article",
    siteName: "Thyself",
  },
  alternates: { canonical: "https://thyself.app/cognitive-functions/infp" },
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "INFP Personality Type — Cognitive Functions, Traits & Growth",
  description:
    "The complete guide to the INFP cognitive function stack (Fi-Ne-Si-Te), loop patterns, grip stress, and growth path. Grounded in Jungian theory.",
  author: { "@type": "Organization", name: "Thyself", url: "https://thyself.app" },
  publisher: { "@type": "Organization", name: "Thyself", url: "https://thyself.app" },
  url: "https://thyself.app/cognitive-functions/infp",
  datePublished: "2026-04-24",
  dateModified: "2026-04-24",
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://thyself.app/cognitive-functions/infp" },
};
    ...
    <>
      ...
      <main className="min-h-screen bg-white">
        ...
        <div className="mx-auto max-w-3xl px-6 py-12 space-y-16">
          ...
          {/* Cognitive wiring */}
          <section>
            <h2 className="mb-4 text-2xl font-bold text-gray-900">How the INFP Mind Works</h2>
          ...
          <section>
            ...
            <p className="mb-4 text-gray-700 text-sm leading-relaxed">
              INFPs are frequently mistyped as other types because cognitive function stacks overlap in surface behavior.
