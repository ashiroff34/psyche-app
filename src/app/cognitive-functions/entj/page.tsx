...
const type = mbtiTypes.find((t) => t.code === "ENTJ")!;

export const metadata: Metadata = {
  title: "ENTJ Personality Type — Cognitive Functions, Traits & Growth | Thyself",
  description:
    "The complete guide to the ENTJ cognitive function stack (Te-Ni-Se-Fi). Understand dominant Extraverted Thinking, auxiliary Introverted Intuition, the Te-Se loop, grip stress, common mistypes, and the ENTJ growth path. Grounded in Jungian theory.",
  openGraph: {
    title: "ENTJ: Cognitive Functions, Traits & Growth",
    description:
      "ENTJs lead with Extraverted Thinking — organizing the external world toward strategic goals — supported by Introverted Intuition. A complete guide to the ENTJ cognitive function stack and growth path.",
    url: "https://thyself.app/cognitive-functions/entj",
    type: "article",
    siteName: "Thyself",
  },
  alternates: { canonical: "https://thyself.app/cognitive-functions/entj" },
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "ENTJ Personality Type — Cognitive Functions, Traits & Growth",
  description:
    "The complete guide to the ENTJ cognitive function stack (Te-Ni-Se-Fi), loop patterns, grip stress, and growth path. Grounded in Jungian theory.",
  author: { "@type": "Organization", name: "Thyself", url: "https://thyself.app" },
  publisher: { "@type": "Organization", name: "Thyself", url: "https://thyself.app" },
  url: "https://thyself.app/cognitive-functions/entj",
  datePublished: "2026-04-24",
  dateModified: "2026-04-24",
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://thyself.app/cognitive-functions/entj" },
};
    ...
    <>
      ...
      <main className="min-h-screen bg-white">
        ...
        <div className="mx-auto max-w-3xl px-6 py-12 space-y-16">
          ...
          {/* Cognitive wiring */}
          <section>
            <h2 className="mb-4 text-2xl font-bold text-gray-900">How the ENTJ Mind Works</h2>
          ...
          <section>
            ...
            <p className="mb-4 text-gray-700 text-sm leading-relaxed">
              ENTJs are frequently mistyped as other types because cognitive function stacks overlap in surface behavior.
