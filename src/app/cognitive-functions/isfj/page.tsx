...
const type = mbtiTypes.find((t) => t.code === "ISFJ")!;

export const metadata: Metadata = {
  title: "ISFJ Personality Type — Cognitive Functions, Traits & Growth | Thyself",
  description:
    "The complete guide to the ISFJ cognitive function stack (Si-Fe-Ti-Ne). Understand dominant Introverted Sensing, auxiliary Extraverted Feeling, the Si-Ti loop, grip stress, common mistypes, and the ISFJ growth path. Grounded in Jungian theory.",
  openGraph: {
    title: "ISFJ: Cognitive Functions, Traits & Growth",
    description:
      "ISFJs lead with Introverted Sensing — maintaining a detailed archive of experience organized for caring — supported by Extraverted Feeling. A complete guide to the ISFJ cognitive function stack and growth path.",
    url: "https://thyself.app/cognitive-functions/isfj",
    type: "article",
    siteName: "Thyself",
  },
  alternates: { canonical: "https://thyself.app/cognitive-functions/isfj" },
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "ISFJ Personality Type — Cognitive Functions, Traits & Growth",
  description:
    "The complete guide to the ISFJ cognitive function stack (Si-Fe-Ti-Ne), loop patterns, grip stress, and growth path. Grounded in Jungian theory.",
  author: { "@type": "Organization", name: "Thyself", url: "https://thyself.app" },
  publisher: { "@type": "Organization", name: "Thyself", url: "https://thyself.app" },
  url: "https://thyself.app/cognitive-functions/isfj",
  datePublished: "2026-04-24",
  dateModified: "2026-04-24",
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://thyself.app/cognitive-functions/isfj" },
};
    ...
    <>
      ...
      <main className="min-h-screen bg-white">
        ...
        <div className="mx-auto max-w-3xl px-6 py-12 space-y-16">
          ...
          {/* Cognitive wiring */}
          <section>
            <h2 className="mb-4 text-2xl font-bold text-gray-900">How the ISFJ Mind Works</h2>
                ...
                <ul className="space-y-2">
                  {type.strengths.map((s) => (
                    <li key={s} className="flex items-start gap-2 text-gray-700">
                      <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full" style={{ backgroundColor: type.color }} />
                      {s}
                    </li>
                  ))}
                </ul>
          ...
          <section>
            <h2 className="mb-4 text-2xl font-bold text-gray-900">
              The {type.loopPattern.functions[0]}-{type.loopPattern.functions[1]} Loop
            </h2>
            <p className="mb-3 text-sm text-gray-500">
              A &ldquo;loop&rdquo; occurs when the dominant function bypasses the auxiliary and connects directly to
              the tertiary — creating an unhealthy inward cycle that can be mistaken for the type&apos;s normal functioning.
            </p>
          ...
          <section>
            <h2 className="mb-4 text-2xl font-bold text-gray-900">
              Inferior Function Grip: {type.stack[3]}
            </h2>
            <p className="mb-3 text-sm text-gray-500">
              Under extreme or prolonged stress, the inferior function can &ldquo;grip&rdquo; the personality —
              taking over in ways that feel alien and out of control.
            </p>
            <div className="rounded-xl border border-gray-100 bg-white p-6 shadow-sm">
          ...
          <section>
            ...
            <p className="mb-4 text-gray-700 text-sm leading-relaxed">
              ISFJs are frequently mistyped as other types because cognitive function stacks overlap in surface behavior.
              Mistyping is best resolved by examining the dominant function — how the type fundamentally
              perceives and processes — rather than behavioral descriptors.
            </p>
            <div className="flex flex-wrap gap-3">
              {type.commonMistypes.map((m) => (
                <Link
                  key={m}
                  href={`/cognitive-functions/${m.toLowerCase()}`}
                  className="rounded-lg border border-gray-200 px-4 py-2 text-sm font-medium text-gray-700 transition-colors hover:border-gray-400 hover:text-gray-900"
                >
                  {m}
                </Link>
              ))}
          ...
          <section>
            ...
            <div className="flex flex-wrap gap-2">
              {ALL_TYPES.map((t) => (
                <Link
                  key={t}
                  href={`/cognitive-functions/${t.toLowerCase()}`}
                  className={`rounded-lg border px-3 py-1.5 text-sm font-medium transition-colors ${
                    t === type.code
                      ? "border-transparent text-white"
                      : "border-gray-200 text-gray-700 hover:border-gray-400"
                  }`}
                  style={t === type.code ? { backgroundColor: type.color } : {}}
                >
                  {t}
                </Link>
              ))}
          ...
          <section className="rounded-2xl px-8 py-10 text-white text-center" style={{ backgroundColor: type.color }}>
            ...
            <p className="mb-6 text-base opacity-90">
              Take the free Thyself Type Index. 10 minutes, no email required.
              Grounded in Jungian cognitive function theory — not pop-psychology quizzes.
            </p>
            <Link
              href="/assessments"
