...
const type = mbtiTypes.find((t) => t.code === "ENTP")!;

export const metadata: Metadata = {
  title: "ENTP Personality Type — Cognitive Functions, Traits & Growth | Thyself",
  description:
    "The complete guide to the ENTP cognitive function stack (Ne-Ti-Fe-Si). Understand dominant Extraverted Intuition, auxiliary Introverted Thinking, the Ne-Fe loop, grip stress, common mistypes, and the ENTP growth path. Grounded in Jungian theory.",
  openGraph: {
    title: "ENTP: Cognitive Functions, Traits & Growth",
    description:
      "ENTPs lead with Extraverted Intuition — generating possibilities and testing them against logic — supported by Introverted Thinking. A complete guide to the ENTP cognitive function stack and growth path.",
    url: "https://thyself.app/cognitive-functions/entp",
    type: "article",
    siteName: "Thyself",
  },
  alternates: { canonical: "https://thyself.app/cognitive-functions/entp" },
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "ENTP Personality Type — Cognitive Functions, Traits & Growth",
  description:
    "The complete guide to the ENTP cognitive function stack (Ne-Ti-Fe-Si), loop patterns, grip stress, and growth path. Grounded in Jungian theory.",
  author: { "@type": "Organization", name: "Thyself", url: "https://thyself.app" },
  publisher: { "@type": "Organization", name: "Thyself", url: "https://thyself.app" },
  url: "https://thyself.app/cognitive-functions/entp",
  datePublished: "2026-04-24",
  dateModified: "2026-04-24",
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://thyself.app/cognitive-functions/entp" },
};
    ...
    <>
      ...
      <main className="min-h-screen bg-white">
        ...
        <div className="mx-auto max-w-3xl px-6 py-12 space-y-16">
          ...
          {/* Cognitive wiring */}
          <section>
            <h2 className="mb-4 text-2xl font-bold text-gray-900">How the ENTP Mind Works</h2>
          ...
          <section>
            ...
            <p className="mb-4 text-gray-700 text-sm leading-relaxed">
              ENTPs are frequently mistyped as other types because cognitive function stacks overlap in surface behavior.
