...
const type = mbtiTypes.find((t) => t.code === "INFJ")!;

export const metadata: Metadata = {
  title: "INFJ Personality Type — Cognitive Functions, Traits & Growth | Thyself",
  description:
    "The complete guide to the INFJ cognitive function stack (Ni-Fe-Ti-Se). Understand dominant Introverted Intuition, auxiliary Extraverted Feeling, the Ni-Ti loop, grip stress, common mistypes, and the INFJ growth path. Grounded in Jungian theory.",
  openGraph: {
    title: "INFJ: Cognitive Functions, Traits & Growth",
    description:
      "INFJs lead with Introverted Intuition — perceiving deep patterns and possibilities — supported by Extraverted Feeling. A complete guide to the INFJ cognitive function stack and growth path.",
    url: "https://thyself.app/cognitive-functions/infj",
    type: "article",
    siteName: "Thyself",
  },
  alternates: { canonical: "https://thyself.app/cognitive-functions/infj" },
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "INFJ Personality Type — Cognitive Functions, Traits & Growth",
  description:
    "The complete guide to the INFJ cognitive function stack (Ni-Fe-Ti-Se), loop patterns, grip stress, and growth path. Grounded in Jungian theory.",
  author: { "@type": "Organization", name: "Thyself", url: "https://thyself.app" },
  publisher: { "@type": "Organization", name: "Thyself", url: "https://thyself.app" },
  url: "https://thyself.app/cognitive-functions/infj",
  datePublished: "2026-04-24",
  dateModified: "2026-04-24",
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://thyself.app/cognitive-functions/infj" },
};
    ...
    <>
      ...
      <main className="min-h-screen bg-white">
        ...
        <div className="mx-auto max-w-3xl px-6 py-12 space-y-16">
          ...
          {/* Cognitive wiring */}
          <section>
            <h2 className="mb-4 text-2xl font-bold text-gray-900">How the INFJ Mind Works</h2>
          ...
          <section>
            ...
            <p className="mb-4 text-gray-700 text-sm leading-relaxed">
              INFJs are frequently mistyped as other types because cognitive function stacks overlap in surface behavior.
