...
const type = mbtiTypes.find((t) => t.code === "ENFP")!;

export const metadata: Metadata = {
  title: "ENFP Personality Type — Cognitive Functions, Traits & Growth | Thyself",
  description:
    "The complete guide to the ENFP cognitive function stack (Ne-Fi-Te-Si). Understand dominant Extraverted Intuition, auxiliary Introverted Feeling, the Ne-Te loop, grip stress, common mistypes, and the ENFP growth path. Grounded in Jungian theory.",
  openGraph: {
    title: "ENFP: Cognitive Functions, Traits & Growth",
    description:
      "ENFPs lead with Extraverted Intuition — perceiving endless possibilities and meaning — supported by Introverted Feeling. A complete guide to the ENFP cognitive function stack and growth path.",
    url: "https://thyself.app/cognitive-functions/enfp",
    type: "article",
    siteName: "Thyself",
  },
  alternates: { canonical: "https://thyself.app/cognitive-functions/enfp" },
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "ENFP Personality Type — Cognitive Functions, Traits & Growth",
  description:
    "The complete guide to the ENFP cognitive function stack (Ne-Fi-Te-Si), loop patterns, grip stress, and growth path. Grounded in Jungian theory.",
  author: { "@type": "Organization", name: "Thyself", url: "https://thyself.app" },
  publisher: { "@type": "Organization", name: "Thyself", url: "https://thyself.app" },
  url: "https://thyself.app/cognitive-functions/enfp",
  datePublished: "2026-04-24",
  dateModified: "2026-04-24",
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://thyself.app/cognitive-functions/enfp" },
};
    ...
    <>
      ...
      <main className="min-h-screen bg-white">
        ...
        <div className="mx-auto max-w-3xl px-6 py-12 space-y-16">
          ...
          {/* Cognitive wiring */}
          <section>
            <h2 className="mb-4 text-2xl font-bold text-gray-900">How the ENFP Mind Works</h2>
          ...
          <section>
            ...
            <p className="mb-4 text-gray-700 text-sm leading-relaxed">
              ENFPs are frequently mistyped as other types because cognitive function stacks overlap in surface behavior.
