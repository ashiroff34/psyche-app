...
const type = mbtiTypes.find((t) => t.code === "INTJ")!;

export const metadata: Metadata = {
  title: "INTJ Personality Type — Cognitive Functions, Traits & Growth | Thyself",
  description:
    "The complete guide to the INTJ cognitive function stack (Ni-Te-Fi-Se). Understand dominant Introverted Intuition, auxiliary Extraverted Thinking, the Ni-Fi loop, grip stress, common mistypes, and the INTJ growth path. Grounded in Jungian theory.",
  openGraph: {
    title: "INTJ: Cognitive Functions, Traits & Growth",
    description:
      "INTJs lead with Introverted Intuition — synthesizing patterns into long-range strategic vision — supported by Extraverted Thinking. A complete guide to the INTJ cognitive function stack and growth path.",
    url: "https://thyself.app/cognitive-functions/intj",
    type: "article",
    siteName: "Thyself",
  },
  alternates: { canonical: "https://thyself.app/cognitive-functions/intj" },
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "INTJ Personality Type — Cognitive Functions, Traits & Growth",
  description:
    "The complete guide to the INTJ cognitive function stack (Ni-Te-Fi-Se), loop patterns, grip stress, and growth path. Grounded in Jungian theory.",
  author: { "@type": "Organization", name: "Thyself", url: "https://thyself.app" },
  publisher: { "@type": "Organization", name: "Thyself", url: "https://thyself.app" },
  url: "https://thyself.app/cognitive-functions/intj",
  datePublished: "2026-04-24",
  dateModified: "2026-04-24",
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://thyself.app/cognitive-functions/intj" },
};
    ...
    <>
      ...
      <main className="min-h-screen bg-white">
        ...
        <div className="mx-auto max-w-3xl px-6 py-12 space-y-16">
          ...
          {/* Cognitive wiring */}
          <section>
            <h2 className="mb-4 text-2xl font-bold text-gray-900">How the INTJ Mind Works</h2>
          ...
          <section>
            ...
            <p className="mb-4 text-gray-700 text-sm leading-relaxed">
              INTJs are frequently mistyped as other types because cognitive function stacks overlap in surface behavior.
