...
export const enneagramAttachmentCorrelations: Record<number, {
  ...
  8: {
    primary: 'dismissive',
    secondary: 'fearful',
    explanation: "Eights primarily express dismissive-avoidant attachment: they maintain a strongly positive self-model (powerful, capable, self-reliant) while devaluing vulnerability and relational need — the hallmarks of Bartholomew's dismissive quadrant. Their early experience often included environments where vulnerability led directly to harm, producing the Eight's characteristic armoring of their tender interior. Eights dismiss vulnerability and devalue dependence on others as weakness. Those with greater self-awareness may access a fearful layer beneath the toughness — a terror of being controlled or betrayed — but the surface presentation is characteristically dismissive rather than fearful."
  },
  9: {
    primary: 'dismissive',
    secondary: 'secure',
    explanation: "Nines paradoxically combine the surface appearance of security with the deeper structure of dismissive avoidance: they merge with others rather than developing genuine intimacy, self-erasing in a way that deactivates their own attachment needs before they can be disappointed. The Nine's characteristic numbing of desire and self-forgetting closely parallel the dismissive deactivation of the attachment system — but through a distinct mechanism: not the self-assertion and active devaluation of others typical of classic dismissive-avoidant (which involves a positive self-model), but rather self-dissolution and self-erasure. The Nine erases themselves to avoid relational friction, where a classic dismissive type asserts independence. The dismissive label is the closest match, but this distinction matters. Healthy Nines can develop genuine secure attachment as they learn to remain present as themselves."
  },
};
