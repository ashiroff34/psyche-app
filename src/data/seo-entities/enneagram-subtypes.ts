...
export const ENNEAGRAM_SUBTYPES: SubtypeEntity[] = [
  ...
  },
  {
    ...
    metaDescription: "The SO-8 redirects lust into fierce group protection — the social justice champion, the rebel-with-a-cause, the most tender expression of Enneagram Type 8.",
  ...
  },
  {
    ...
    intro: "The SX-8 is the countertype: the Eight whose characteristic armor is dismantled by the drive toward total intimate surrender. Their lust flows toward the specific beloved with a totalizing intensity — they want possession complete and undivided, and they offer the same. The keyword 'Possession/Surrender' contains the paradox: they seek to possess and to surrender simultaneously, which makes their intimate relationships among the most intense of all twenty-seven subtypes.",
    ...
    metaDescription: "The SX-8 countertype: lust meets surrender, dismantling the Eight's armor in intimate bonds — the most intensely vulnerable, all-or-nothing expression of Enneagram Type 8.",
