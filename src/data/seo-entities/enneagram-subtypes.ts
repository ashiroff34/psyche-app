...
export const ENNEAGRAM_SUBTYPES: SubtypeEntity[] = [
  ...
  },
  {
    ...
    isCountertype: true,
    countertypeReason: "Lust is redirected entirely to group protection; the Eight's characteristic domination and territorial aggression is channeled into fierce advocacy for the weak",
