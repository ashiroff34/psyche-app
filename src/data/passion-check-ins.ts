...
export const PASSION_CHECK_INS: Record<number, PassionCheckIn[]> = {
  ...
  3: [
    { question: "What version of yourself did you perform in the last hour?", passionWord: "Deceit" },
    { question: "Where did you choose the impressive thing over the true thing?", passionWord: "Deceit" },
    { question: "Whose admiration were you trying to earn today?", passionWord: "Deceit" },
    { question: "What did you accomplish that didn't actually matter to you?", passionWord: "Deceit" },
    { question: "When did you feel like the image and the inside didn't match?", passionWord: "Deceit" },
    { question: "What would you do if no one was watching today?", passionWord: "Deceit" },
    { question: "Where did you hide a feeling because it would look bad?", passionWord: "Deceit" },
  ],
  4: [
