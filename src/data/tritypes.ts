...
export const tritypes: Tritype[] = [
  ...
  { code: "135", archetype: "The Technical Expert", description: "Principled, achieving, and investigative. Combines mastery, competence, and precision into someone who pursues excellence through deep expertise. Highly capable and efficient.", strengths: ["Deep expertise and competence", "Efficient and results-oriented", "High standards backed by knowledge"], challenges: ["Can be emotionally detached", "May prioritize competence over connection", "Perfectionistic about expertise"] },
  ...
  { code: "259", archetype: "The Problem Solver", description: "Helpful, investigative, and peaceful. Combines care, knowledge, and acceptance. A gentle, knowledgeable supporter who helps through understanding rather than force.", strengths: ["Gentle and insightful helper", "Accepting and knowledgeable", "Non-intrusive support"], challenges: ["Can be passive in their helping", "May withdraw when overwhelmed", "Difficulty asserting boundaries"] },
  ...
  // 278 combinations
  { code: "278", archetype: "The Free Spirit", description: "Helpful, enthusiastic, and powerful. Combines warmth, optimism, and force. An energetic, generous spirit who uplifts others with charisma and positive intensity.", strengths: ["Charismatic and generous", "Energetic and uplifting", "Powerful positive presence"], challenges: ["Can be overwhelming in intensity", "May avoid depth for positivity", "Difficulty with limits and boundaries"] },
